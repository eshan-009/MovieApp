...
import bigsearch from "./create.js"
function searchinputevent(elem,data){
  
    elem.addEventListener("input",(event)=>{
      console.log("MMMANAH",searchinput);
    ...
    elem.addEventListener("blur",(event)=>{
        setTimeout(()=>{
            ...
            console.log("MMMANAH",searchinput.classList);
        },200)
    ...
    function search(query){
       ...
       const input = query.toLowerCase();
        ...
        .map((item)=>{
            ...
            // para.addEventListener("click",(event,item)=>{
            //     console.log("ATTACK2",item);
            //     // opensearchitem.opensearchitem(item.target.value);
            // })
